...
class TestCLISignupFlow:
    ...
    def test_successful_signup_with_consent_acceptance(self, isolated_test_env):
        ...
        with patch(
            "sys.argv", ["cli", "signup", "newuser", "password123"]
        ), patch.object(builtins, "input", return_value="y"), patch(
    ...
    def test_successful_signup_with_consent_denial(self, isolated_test_env):
        ...
        with patch(
            "sys.argv", ["cli", "signup", "newuser", "password123"]
        ), patch.object(builtins, "input", return_value="n"), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
    ...
    def test_signup_duplicate_username(self, isolated_test_env):
        ...
        with patch("sys.argv", ["cli", "signup", "existinguser", "newpassword"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
...
class TestCLILoginFlow:
    ...
    def test_successful_login_with_existing_consent(self, isolated_test_env):
        ...
        with patch("sys.argv", ["cli", "login", "testuser", "password123"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
    ...
    def test_login_first_time_with_consent_acceptance(self, isolated_test_env):
        ...
        with patch(
            "sys.argv", ["cli", "login", "newuser", "password123"]
        ), patch.object(builtins, "input", return_value="y"), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
    ...
    def test_login_invalid_credentials(self, isolated_test_env):
        ...
        with patch("sys.argv", ["cli", "login", "testuser", "wrongpassword"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
    ...
    def test_login_nonexistent_user(self, isolated_test_env):
        ...
        with patch("sys.argv", ["cli", "login", "nonexistent", "password123"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
...
class TestCLIConsentCommands:
    ...
    def test_consent_status_check_with_consent(
        ...
        with patch("sys.argv", ["cli", "consent", "--status"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
    ...
    def test_consent_status_check_without_consent(
        self, isolated_test_env, temp_session_file
    ):
    ...
    def test_consent_update_for_non_consented_user(
        self, isolated_test_env, temp_session_file
    ):
        ...
        with patch("sys.argv", ["cli", "consent", "--update"]), patch.object(
    ...
    def test_consent_update_for_already_consented_user(
        self, isolated_test_env, temp_session_file
    ):
        ...
        with patch("sys.argv", ["cli", "consent", "--update"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
...
class TestCLIAnalyzeFlow:
    ...
    def test_analyze_requires_login(self, isolated_test_env):
        ...
        with patch("sys.argv", ["cli", "analyze", "/some/path"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
    ...
    def test_analyze_with_invalid_path(self, isolated_test_env, temp_session_file):
        ...
        with patch("sys.argv", ["cli", "analyze", "/nonexistent/path"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
    ...
    def test_analyze_with_valid_path(
        self, isolated_test_env, temp_session_file, test_directory
    ):
        ...
        with patch("sys.argv", ["cli", "analyze", str(test_directory)]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            output = fake_out.getvalue()
...
class TestCLIEndToEndWorkflow:
    ...
    def test_complete_happy_path_workflow(
        self, isolated_test_env, temp_session_file, test_directory
    ):
        """Test complete workflow: signup -> login -> analyze."""
        # Step 1: Signup with consent
        with patch("sys.argv", ["cli", "signup", "alice", "alicepass"]), patch.object(
            builtins, "input", return_value="y"
        ), patch("sys.stdout", new=StringIO()) as fake_out:
            result = main()
            assert result == 0
        ...
        with patch("sys.argv", ["cli", "login", "alice", "alicepass"]), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
            assert result == 0
    ...
    def test_workflow_with_consent_denial_then_update(
        self, isolated_test_env, temp_session_file, test_directory
    ):
        ...
        with patch("sys.argv", ["cli", "signup", "bob", "bobpass"]), patch.object(
        ...
        with patch("sys.argv", ["cli", "login", "bob", "bobpass"]), patch.object(
            builtins, "input", return_value="n"
        ), patch("sys.stdout", new=StringIO()) as fake_out:
            result = main()
    ...
    def test_workflow_signup_first_time_login_with_consent(
        self, isolated_test_env, temp_session_file
    ):
        ...
        with patch(
            "sys.argv", ["cli", "login", "charlie", "charliepass"]
        ), patch.object(builtins, "input", return_value="y"), patch(
            "sys.stdout", new=StringIO()
        ) as fake_out:
            result = main()
    ...
    def test_workflow_multiple_login_attempts_after_consent_denial(
        self, isolated_test_env
    ):
        """Test workflow: signup (deny) -> multiple login attempts (all should fail)."""
        # Step 1: Signup with consent denial (returns 1)
        with patch("sys.argv", ["cli", "signup", "dave", "davepass"]), patch.object(
            builtins, "input", return_value="n"
        ...
        with patch("sys.argv", ["cli", "login", "dave", "davepass"]), patch.object(
            builtins, "input", return_value="n"
        ), patch("sys.stdout", new=StringIO()) as fake_out:
            result = main()
            assert result == 1
