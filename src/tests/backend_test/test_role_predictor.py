...
class TestRolePredictionScenarios:
    ...
    def test_predict_senior_software_engineer(self):
        ...
        project_data = {
            ...
            "has_docker": True,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 300, "total_contributors": 5},
            "oop_analysis": {"total_classes": 25, "oop_score": 5, "solid_score": 4.5},
            "score_data": {"composite_score": 85},
        }

        prediction = predict_developer_role(project_data)

        assert prediction.predicted_role in [DeveloperRole.SENIOR_SOFTWARE_ENGINEER, DeveloperRole.TEAM_LEAD_ARCHITECT]
    ...
    def test_predict_frontend_developer(self):
        ...
        project_data = {
            ...
            "has_docker": False,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 80, "total_contributors": 2},
    ...
    def test_predict_devops_engineer(self):
        ...
        project_data = {
            ...
            "has_docker": True,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 100, "total_contributors": 2},
    ...
    def test_predict_mobile_developer(self):
        ...
        project_data = {
            ...
            "has_docker": False,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 120, "total_contributors": 2},
            "score_data": {"composite_score": 58},
        }
    ...
    def test_predict_data_engineer(self):
        ...
        project_data = {
            ...
            "has_docker": True,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 90, "total_contributors": 3},
            "score_data": {"composite_score": 68},
        }

        prediction = predict_developer_role(project_data)

        assert prediction.predicted_role in [DeveloperRole.DATA_ENGINEER, DeveloperRole.ML_ENGINEER]
        assert prediction.confidence_score > 0.4
    ...
    def test_predict_ml_engineer(self):
        ...
        project_data = {
            ...
            "has_docker": True,
            "has_ci_cd": False,
            "git_analysis": {"total_commits": 60, "total_contributors": 1},
    ...
    def test_predict_junior_developer(self):
        ...
        project_data = {
            ...
            "has_docker": False,
            "has_ci_cd": False,
            "git_analysis": {"total_commits": 15, "total_contributors": 1},
            "score_data": {"composite_score": 25},
        }
    ...
    def test_predict_game_developer(self):
        ...
        project_data = {
            ...
            "has_docker": False,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 200, "total_contributors": 4},
    ...
    def test_predict_systems_engineer(self):
        ...
        project_data = {
            ...
            "has_docker": False,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 150, "total_contributors": 2},
            "score_data": {"composite_score": 75},
        }
...
class TestEdgeCases:
    ...
    def test_missing_optional_fields(self):
        ...
        project_data = {"project_name": "Test Project", "languages": {"python": 5}}
    ...
    def test_very_large_project(self):
        ...
        project_data = {
            ...
            "has_docker": True,
            "has_ci_cd": True,
            "git_analysis": {"total_commits": 50000, "total_contributors": 100},
            "score_data": {"composite_score": 95},
        }
...
class TestFormatting:
    ...
    def test_format_role_prediction(self):
        ...
        prediction = RolePrediction(
            predicted_role=DeveloperRole.SENIOR_SOFTWARE_ENGINEER,
            confidence_score=0.85,
            alternative_roles=[(DeveloperRole.BACKEND_DEVELOPER, 0.7), (DeveloperRole.TEAM_LEAD_ARCHITECT, 0.65)],
            reasoning=[
