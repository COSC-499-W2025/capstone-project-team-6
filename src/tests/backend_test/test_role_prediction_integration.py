...
from backend.analysis_database import init_db, record_analysis, get_analysis
...
class TestRolePredictionDatabaseIntegration:
    ...
    def temp_db(self):
        """Create a temporary database for testing."""
        from backend.analysis_database import set_db_path, init_db
    ...
    def test_retrieve_analysis_includes_role_prediction(self, temp_db):
        ...
        from backend.analysis_database import record_analysis, get_analysis
        ...
        projects = [
            ...
            },
            {
                ...
                "data": {
                    "languages": {"python": 25},
                    "frameworks": ["Django"],
                    "score_data": {"composite_score": 70.0}
                }
            }
        ]
...
class TestEndToEndRolePrediction:
    ...
    def test_role_prediction_different_inputs(self):
        ...
        assert (frontend_prediction.predicted_role != backend_prediction.predicted_role or
                abs(frontend_prediction.confidence_score - backend_prediction.confidence_score) > 0.1)
