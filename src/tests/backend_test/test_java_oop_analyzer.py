...
"""
        ...
        assert result.generic_classes == 1
    
    def test_enum(self):
        """Test detecting enums."""
        code = """
public enum Day {
...
"""
        ...
        assert result.enum_count == 1
    
    def test_annotations(self):
        """Test detecting various annotations."""
        code = """
@Component
...
"""
        ...
        assert "Autowired" in result.annotations
        assert "Override" in result.annotations
...
"""
        ...
        assert "Repository" in result.design_patterns
...
"""
        ...
        assert "Service Layer" in result.design_patterns
