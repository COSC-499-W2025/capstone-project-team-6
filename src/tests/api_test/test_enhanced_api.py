...
from backend.analysis_database import get_all_analyses, init_db
...
class TestEnhancedAPI:
    ...
    def setup_method(self):
        ...
        # Create test user
        self.test_user = {"username": f"testuser_{uuid.uuid4().hex[:8]}", "password": "password123"}
...
""",
    ...
    def test_portfolio_upload_new(self):
        ...
        with open(zip_path, "rb") as f:
            ...
            response = client.post("/api/portfolios/upload", files=files, data=data, headers=self.headers)
    ...
    def test_task_access_control(self):
        ...
        # Create another user
        other_user = {"username": f"otheruser_{uuid.uuid4().hex[:8]}", "password": "password123"}
    ...
    async def test_task_creation(self):
        ...
        try:
            ...
            task_id = task_manager.create_task(
                task_type="new_portfolio", username="testuser", filename="test.zip", file_path=temp_file, analysis_type="non_llm"
            )
    ...
    async def test_user_task_filtering(self):
        ...
        try:
            ...
            task1 = task_manager.create_task(
                task_type="new_portfolio", username="user1", filename="test1.zip", file_path=temp_file1
            )

            task2 = task_manager.create_task(
                task_type="new_portfolio", username="user2", filename="test2.zip", file_path=temp_file2
            )
