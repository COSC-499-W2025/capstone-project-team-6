...
class DocumentAnalyzer:
    ...
    def analyze(self) -> DocumentAnalysis:
        ...
        analysis = DocumentAnalysis(file_path=self.file_path, file_type=self.file_type)
    ...
    def _generate_resume_highlights(self, analysis: DocumentAnalysis) -> List[str]:
        ...
        if (
            analysis.citation_analysis.in_text_count >= 10
            and analysis.writing_metrics.word_count >= 1500
